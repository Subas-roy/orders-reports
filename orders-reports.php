...
function reports_admin_menu() {
  ...
  add_submenu_page('orders_reports_admin', 'Yearly', 'Yearly', 'manage_options', 'yearly_reports', 'yearly_reports_page' );
}
      ...
      <div class="col">
        <div class="card text-center">
          ...
          <div class="card-body">
            ...
            ?>
            <p class="card-text"><?php echo $total ?> Order(s)</p>
            <a href="<?php echo site_url();?>/wp-admin/admin.php?page=yearly_reports" class="btn btn-primary">Details</a>
          </div>
          <div class="card-footer text-muted">
            Past year
          </div>
          ...
          <div class="mb-3" id="orTable">
            <div id="quick_links" class="">
              <ul class="nav">
                ...
                <li class="nav-item"><a class="nav-link" href="<?php echo site_url();?>/wp-admin/admin.php?page=yearly_reports">Yearly</a></li>
              </ul>
            </div>
            ...
            <table class="table table-responsive">
              <thead id="dayThead">
                <tr>
                  ...
                  $highest = 0;
                  foreach($unique_orders as $normal_order){
                    $order = wc_get_order( $normal_order );

                    $total_product = count( $order->get_items() );

                    if($total_product > $highest){
                      $highest = $total_product;
                    }
                  }
                  
                  for($i = 1; $i <= $highest; $i++) : ?>
                  <td scope="col">Product <?php echo $i; ?></td>
                  <?php endfor; ?>
                </tr>
              </thead>
              <tbody id="dayTbody">
                <?php
                  foreach( $unique_orders as $order_id ){
                    ...
                    ?>
                <caption id="dayTotal">Total <?php echo $total;?> Order(s)</caption>
              </tbody>
            </table>
          </div>
        </div>
              ...
              <tbody id="weekTbody">
                <?php
                  foreach( $unique_orders as $order_id ){
                    ...
                    ?>
                <caption id="yearTotal">Total <?php echo $total;?> Order(s)</caption>
              </tbody>
            </table>
          </div>
        </div>
              ...
              <tbody id="monTbody">
                <?php
                  foreach( $unique_orders as $order_id ){
                    ...
                    ?>
                <caption id="monTotal">Total <?php echo $total;?> Order(s)</caption>
              </tbody>
            </table>
          </div>
        </div>
          ...
          <div class="mb-3" id="orTable">
            <div id="quick_links" class="">
              <ul class="nav">
                ...
                <li class="nav-item"><a class="nav-link" href="<?php echo site_url();?>/wp-admin/admin.php?page=weekly_reports">Weekly</a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo site_url();?>/wp-admin/admin.php?page=monthly_reports">Monthly</a></li>
                <li class="nav-item"><a class="nav-link active_link" href="<?php echo site_url();?>/wp-admin/admin.php?page=yearly_reports">Yearly</a></li>
              </ul>
            </div>
            <h3 class="text">Yearly Orders Report<span id="daily_orders"></span></h3>
            <table class="table table-responsive">
              <thead id="yrThead">
                <tr>
                  <td scope="col">Customer Name</td>
